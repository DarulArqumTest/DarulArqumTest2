  ...
  return (
    <div ref={rootRef} className="relative">
      <button
        ...
        onClick={() => setOpen((v) => !v)}
        aria-expanded={open}
        className="da-donate-glow rounded-[11px] bg-da-gold px-[22px] py-2.5 text-[13.5px] font-semibold text-da-bg transition-transform hover:-translate-y-0.5 hover:brightness-110"
      >
        Donate
      </button>
