 ...
 *
 * One line weight, one 24-unit box, `currentColor` throughout, so a row of
 * them reads as one hand rather than a pile of clip art. No animation: these
 * label things, and a label that bobs is just harder to read.
 */
...
const PATHS: Record<GlyphName, React.ReactNode> = {
  ...
  hifz: (
    <>
      ...
      <path {...S} d="M8.6 8.2h6.6M8.6 11.2h6.6" opacity={0.55} />
      <path {...S} d="M11.9 17.5c-1.5-1.1-2.3-1.8-2.3-2.7a1.3 1.3 0 0 1 2.3-.8 1.3 1.3 0 0 1 2.3.8c0 .9-.8 1.6-2.3 2.7Z" />
    </>
  ),
  ...
  hadith: (
    <>
      ...
      <path {...S} d="M7.6 14.8h8.8M7.6 17.4h5.6" opacity={0.55} />
    </>
  ),
  ...
  grammar: (
    <>
      ...
      <circle cx="8" cy="7.4" r="1.05" fill="currentColor" />
      <circle cx="16.4" cy="6.6" r="1.05" fill="currentColor" />
  ...
  calendar: (
    <>
      ...
      <rect x="10.7" y="16.6" width="2.6" height="2.6" rx="0.7" fill="currentColor" opacity={0.35} />
    </>
  ),
  ...
  history: (
    <>
      ...
      <path {...S} d="M8.4 12.6h7.2M8.4 15.4h4.6" opacity={0.6} />
    </>
  ),
